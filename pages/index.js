    ...
    <div className="flex flex-col justify-center h-screen">
      ...
      <header className="flex justify-between w-full p-5 text-sm text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <Avatar url="https://d34u8crftukxnk.cloudfront.net/slackpress/prod/sites/6/IQ-Accountants-managing-partner-Kyelie-Baxter-Slack-customer-story.jpg"></Avatar>
        </div>
      </header>

      <form className="flex flex-col items-center mt-20 flex-grow">
        <Image
          src="https://www.google.com.bd/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png"
          alt="download"
          height={100}
          width={300}
        ></Image>
